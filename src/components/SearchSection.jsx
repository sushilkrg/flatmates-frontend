    ...
    return (
        <section className="bg-gray-800 h-[450px] md:h-[400px] py-8 px-4 ">
            <div className="container mx-auto">
                <h2 className="text-2xl text-center font-semibold mb-6 mt-8">Search for a Flatmate/Roommate</h2>
                <div className="flex flex-col md:flex-row gap-4 justify-center items-center mt-20">
                    <input
                        type="text"
                        placeholder="Enter City Name"
                        value={cityName}
                        className="p-3 border text-black border-gray-300 rounded-md w-full md:w-1/2 focus:outline-none focus:border-blue-400"
